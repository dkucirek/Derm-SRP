...
result_info[, race_refined := fcase(
  ...
  race %in% c("Chinese", "Japanese", "Korean", "Filipino", "Vietnamese", "Native Hawaiian", "Native Hawaiian/Other Pacific Islander", "Other Pacific Islander", "Guamanian or Chamorro", "Samoan", "American Indian or Alaska Native", "None of the above", "Other"), "Other",
  race == "White", "White",
