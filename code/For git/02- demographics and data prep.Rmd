...
result_info[, race_refined := fcase(
  ...
  race %in% c("Native Hawaiian", "Native Hawaiian/Other Pacific Islander", "Other Pacific Islander", "Guamanian or Chamorro", "Samoan", "American Indian or Alaska Native", "None of the above", "Other"), "Other",
...
# define has_psych_condition based on timing--needs behavioral care visit before chronic derm diagnosis
patient_first_visits[, has_psych_condition_timed := !is.na(first_psych_visit) & !is.na(first_chronic_derm_visit) & (first_psych_visit < first_chronic_derm_visit)]
